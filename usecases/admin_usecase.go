...
type AdminUseCaseInterface interface {
	...
	GetAdmins() repositories.RepositoryResult[[]models.Admin]
...
func (u *adminUsecase) GetAdmins() repositories.RepositoryResult[[]models.Admin] {
	result := u.AdminRepository.GetAdmins()
	adminsResult := <-result
	return adminsResult
}
